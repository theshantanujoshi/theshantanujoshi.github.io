              ...
              <div className="flex flex-col items-center justify-center w-full z-10">
                ...
                >
                  <motion.div
                    ...
                    className="absolute left-1/2 top-[55%] -translate-x-1/2 -translate-y-1/2 w-[150vw] h-[80vh] md:w-[60vw] md:h-[80vh] -z-10 pointer-events-none flex justify-center items-center"
                    style={{
